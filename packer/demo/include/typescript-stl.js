...
(function (std) {
    ...
    (function (base) {
        ...
        var SetContainer = (function () {
             ...
             * @inheritdoc
             */
            SetContainer.prototype.empty = function () {
                return this.size() == 0;
            };
            /* =========================================================
                ELEMENTS I/O
...
(function (std) {
    ...
    var HashMultiSet = (function (_super) {
        ...
        function HashMultiSet() {
            ...
            else if (args.length == 1 && args[0] instanceof std.HashSet) {
                // COPY CONSTRUCTOR
                var container = args[0];
                this.assign(container.begin(), container.end());
            }
...
(function (std) {
    ...
    var PriorityQueue = (function () {
        function PriorityQueue() {
            ...
            if (args.length >= 1
                && args[0].begin != undefined
                && args[0].end != undefined
                && args[0].assign != undefined) {
                // COPY CONSTRUCTOR
